            ...
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col">
                        <center>
                            <img id="imgview" width="100" src="images/books%20(2).jpg" />
                        </center>
                     </div>
                  </div>
                  <div class="row">
                                        ...
                                        <div class="container-fluid">
                                            <div class="row">
                                                <div class="col-lg-10">
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <asp:Label ID="Label8" runat="server" Font-Bold="True" Font-Size="X-Large" Text='<%# Eval("book_name") %>'></asp:Label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            ...
                                                            Author-<asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Medium" Text='<%# Eval("author_name") %>'></asp:Label>
                                                            &nbsp;| Genre-<asp:Label ID="Label2" runat="server" Font-Bold="True" Text='<%# Eval("genre") %>'></asp:Label>
                                                            &nbsp;| Language-<asp:Label ID="Label3" runat="server" Font-Bold="True" Text='<%# Eval("language") %>'></asp:Label>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            ...
                                                            &nbsp;| Publish Date-<asp:Label ID="Label5" runat="server" Font-Bold="True" Text='<%# Eval("publish_date") %>'></asp:Label>
                                                            &nbsp;| Pages-<asp:Label ID="Label6" runat="server" Font-Bold="True" Text='<%# Eval("no_of_pages") %>'></asp:Label>
